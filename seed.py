...
with app.app_context():
  ...
  #   # Movement seeding
    squatpulses = MovementModel(name="Squat Pulses", description="1. From a standing position and your knees off lock - remember to keep your ears, shoulders and hip in line and your spine in neutral and brace your abdominals 2. From this position slowly lower into a squat position 3. During the lowering movement make sure your heels remain flat and in contact withthe ground - this downward movement is about hinging at the hip and sticking your bottom out imagining you are about to sit onto the toilet. 4. Stay in the squat position, gently pulse your legs in an up and down motion - make sure to maintain the tension in your thigh muscles throughout Be sure to keep the abdominals braced throughout Progression The deeper the squat (the lower you go) the greater the intensity of the exercise - make sure to keep your feet flat on the floor and let this gauge how low you go", image="https://imgur.com/a/3nAPLnc", type="Strength", equipment="bodyweight", video="https://youtu.be/6VSTURgU0LQ", adaption="Slightly lowering into the squat and not lowering too deep will reduce the intensity of the exercise and allow for a gentler movement", user_id=bertie.id)
    squatpulses.save()

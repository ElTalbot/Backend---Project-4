...
with app.app_context():
  ...
  #   # Movement seeding
    ...
    # Session seeding..
        saturday = SessionModel(name="360degree Wake Up", date=date(2024, 4, 20), day="Saturday", capacity= 2, user_id=bertie.id)
